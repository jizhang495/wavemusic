...
The legacy alias `saw:` is currently accepted, but Python should emit
`sawtooth:`.
...
- Python should emit lower-case notes and waveform names.
...
- Normalize waveform names to `sine`, `square`, `triangle`, or `sawtooth`.
